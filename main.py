...
from topic_manager import register_topic_commands
register_topic_commands(bot, db=db)
        ...
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                if "static-trans-v1.classx.co.in" in url:
                    base_clean = base_clean.replace("https://static-trans-v1.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
                elif "static-trans-v2.classx.co.in" in url:
                    base_clean = base_clean.replace("https://static-trans-v2.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
                ...
                base_clean = base_clean.replace("https://static-rec.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
                ...
                clean_url = clean_url.replace("https://static-wsb.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
                ...
                if "*" in url:
                    ...
                    base_url = base_url.replace("https://static-db.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
                    url = f"{base_url}*{key}"
                else:
                    base_url = url.split("?")[0]
                    url = base_url.replace("https://static-db.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")


            elif "https://static-db-v3.classx.co.in/" in url:
                if "*" in url:
                    base_url, key = url.split("*", 1)
                    base_url = base_url.split("?")[0]
                    base_url = base_url.replace("https://static-db-v3.classx.co.in", "https://master-api-v3.vercel.app")
                    url = f"{base_url}*{key}"
                else:
                    base_url = url.split("?")[0]
                    url = base_url.replace("https://static-db-v3.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
            ...
            if ".pdf*" in url:
                url = f"https://master-api-v3.vercel.app/appxv2-pdf"
...
if "drive" in url:
    ...
    prog = await bot.send_message(
        ...
        text=Show,
        disable_web_page_preview=True,
        message_thread_id=TOPIC_ID  # ✅ topic me status
    )
    ...
    await helper.send_vid(
        bot, m, cc, filename, thumb, name, prog,
        channel_id,
        watermark=watermark,
        topic_thread_id=TOPIC_ID   # ✅ topic me video upload
    )
    ...
    await helper.send_vid(
        ...
        channel_id,
        watermark=watermark,
        topic_thread_id=TOPIC_ID  # ✅ topic me upload
    )
    ...
    await bot.send_message(
        ...
        disable_web_page_preview=True,
        message_thread_id=TOPIC_ID  # ✅ topic me fail msg
    )
    count += 1
    failed_count += 1
    continue
    ...
    await bot.send_message(
        chat_id=channel_id,
        text=str(e),
        message_thread_id=TOPIC_ID  # ✅ topic me error
    )
    time.sleep(2)
...
if raw_text7 == "/d":
    await bot.send_message(
        ...
        message_thread_id=TOPIC_ID  # ✅ topic me summary
    )
    ...
    # ✅ User ko private notification (topic ki zarurat nahi)
    await bot.send_message(
        chat_id=m.chat.id,
        text="<blockquote><b>✅ Your Task is completed, please check your Set Channel📱</b></blockquote>"
    )
    ...
    try:
            ...
            if "acecwply" in url:
                ...
                if "*" in url:
                    base_url, key = url.split("*", 1)
                    base_url = base_url.split("?")[0]
                    base_url = base_url.replace("https://static-db-v2.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
                    url = f"{base_url}*{key}"
                else:
                    base_url = url.split("?")[0]
                    url = base_url.replace("https://static-db-v2.classx.co.in", "https://master-api-v3.vercel.app/appxv2-pdf")
...
def reset_and_set_commands():
   ...
   commands = [
    ...
    # 🔽 Topic Management
    {"command": "checkforum", "description": "🧩 Check forum / topic support"},
    {"command": "testtopic", "description": "🧪 Test message in a topic"},
    {"command": "testextract", "description": "🔎 Extract topic ID from link"},
    {"command": "createtopic", "description": "➕ Create a new topic"},
    {"command": "listtopics", "description": "📌 List cached topics"},
    {"command": "cleartopics", "description": "🧹 Clear topic cache (admin only)"},
]
